function [ROC_struct] = psycho_calcAFC(AFC_struct)
  ...
  ROC_struct.AFC_std = zeros(size(ROC_struct.AFC_AUC));
  for i_combination = 1 : num_combinations
    ROC_struct.AFC_error{i_combination} = ...
	ROC_struct.AFC_error{i_combination}.^2;
    ROC_struct.AFC_std(i_combination) = ...
	ROC_struct.AFC_AUC(i_combination).^2;
  end
  ...
  for i_combination = 1 : num_combinations
	...
	AFC_struct.num_IDs;
    ROC_struct.AFC_error{i_combination} = ...
	sqrt(ROC_struct.AFC_error{i_combination}  / ...
	     AFC_struct.num_IDs);
    ...
    ROC_struct.AFC_std(i_combination) = ...
	sqrt((ROC_struct.AFC_std(i_combination)  / ...
	      AFC_struct.num_IDs) - ...
	     ROC_struct.AFC_AUC(i_combination).^2);
